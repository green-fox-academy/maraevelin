...
public class HeroBattle {
   ...
   *
   * You will need a battle.Hero class which is also a battle.BaseHero and is a battle.Punchable (these are provided to you)
   ...
   *
   * You will need also a battle.DCHero and a battle.MarvelHero classes. They extend the battle.Hero class
   * with a restriction, they cannot punch other heroes from the same "Universe":
   * - A battle.MarvelHero shouldn't be able to punch another battle.MarvelHero
   * - A battle.DCHero shouldn't be able to punch another battle.DCHero
   * Also they should have a default motivation if only the name is provided when we create them. Default values:
   * - battle.MarvelHero: 40
   * - battle.DCHero: 45
